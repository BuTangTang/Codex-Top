...
2026-09-25 D-12/D-13/D-14本批收口：Android1.0.27与Mac47已安装，最近数量设置、电脑／项目子页、逐层返回及标题实测通过。手机同任务收发与运行到完成通过；notLoaded旧任务自动打开通过，首次基线失败恢复补丁经33项／独立复核及最终包旧任务回读通过。独立CONTROL瞬态无观察变化仍手动刷新，完整历史／审批／真机／推送等缺项保留。详见[本批验收](../../validation/mobile-state-recovery.md)。
