...
当前源码与本机安装为 v1.0.0 build 31。D-79 统一浅色实色背景和细边，D-78 双列菜单及既有尺寸、字体、动画和任务逻辑保留。160 项测试及当前真实主题检查范围见 [本轮验收](validation/solid-light-theme.md)；历史完整连续动画与跨屏验收不借用本轮结论。中英文 README 四模式图片仍对应 build 10。公开 Release 附件未变。
