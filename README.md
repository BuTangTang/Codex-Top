...
当前源码与本机安装为 **v1.0.0 build 31**。浅色监控改为与菜单一致的不透明浅白，保留深色／浅色／系统三项，尺寸、字体和动画不变。160 项测试通过，真实包已核对系统浅色、手动浅色与深色，见[本轮验证及边界](docs/validation/solid-light-theme.md)。双列快捷菜单、7 天自动整理、右键整理和 80%–120% 比例保留。[已发布安装包](https://github.com/BuTangTang/Codex-Top/releases)与源码版本分别记录。
